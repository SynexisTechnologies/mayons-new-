...
const translations = {
  en: {
    ...
    /* ABOUT PAGE */
    aboutTitle: "About Organi Fresh Product",
    aboutDescription:
    ...
    ourStoryP1:
      "Founded in 2020, Organi Fresh Product started with a simple idea: everyone deserves access to fresh, organic produce that's good for both people and the planet.",
    ourStoryP2:
    ...
    whyChooseTitle: "The Organi Difference",
...
passwordRules: "Password must be at least 6 characters and contain letters & numbers",
...
contactTitle: "Contact Us",
    contactSubtitle: "We'd love to hear from you. Reach out for support, feedback, or inquiries.",
    ...
    contactFormDesc: "Fill out the form below and we'll get back to you shortly.",
...
/* ===== Cart Page ===== */
  ...
  event1_desc: 'Join us for the biggest organic food festival featuring 100+ vendors, cooking demonstrations, and farm tours.',
  ...
  event2_desc: 'Meet local organic farmers and get the freshest produce directly from the source.',
  ...
  event3_desc: 'Learn to prepare delicious organic meals from professional chefs.',
  ...
  event4_desc: 'Discover tips and tricks for living a more sustainable and eco-friendly lifestyle.',
  ...
  event5_desc: 'Experience organic farming firsthand and learn about sustainable agriculture practices.',
  ...
  event6_desc: 'Explore organic beauty products, wellness solutions, and natural skincare.',
...
menu_breakfast: "Breakfast",
  ...
  avocadoToastDesc: "Organic sourdough with smashed avocado and cherry tomatoes.",
  grilledChickenDesc: "Free-range chicken with seasonal vegetables and quinoa.",
  buddhaBowlDesc: "Quinoa, roasted vegetables, chickpeas with tahini dressing.",
  ...
  freshBroccoli_desc: "Fresh organic broccoli grown naturally without chemicals. Rich in vitamins and perfect for a healthy diet.",
  organicHoodie_desc: "Premium organic cotton hoodie — soft, breathable, and sustainably made for everyday comfort.",
  /* ===== Hot Offers Page ===== */
 ...
 Required: "Required",
  ...
  No_Special_Time_Request: "*Special Time requests are not accepted in Delivery Instructions.",
...
/* ABOUT PAGE */
    aboutTitle: "අප ගැන - Organi Fresh Product",
    aboutDescription:
    ...
    ourStoryP1:
      "2020 දී ආරම්භ කරන ලද Organi Fresh Product සරල අදහසකින් ආරම්භ විය: සෑම කෙනෙකුටම මිනිසුන්ට සහ පෘථිවියට හිතකර, නැවුම්, කාබනික නිෂ්පාදන සඳහා ප්‍රවේශය ලැබිය යුතුය.",
    ourStoryP2:
    ...
    whyChooseTitle: "Organi Fresh වෙනස්කම",
...
registerSub: "Organi Fresh Product ජාලයට එක්වන්න",
firstName: "මුල් නම",
lastName: "අවසන් නම",
...
registerInvalidEmail:  "කරුණාකර වලංගු විද්‍යුත් තැපැල් ලිපිනයක් ඇතුළත් කරන්න",
...
/* ===== Cart Page ===== */
  ...
  event1_desc: '100+ වෙළෙන්දන්, කෑම පිසීමේ වැඩසටහන් සහ ගොවිපොල සංචාර ඇතුළත් විශාලතම කාබනික ආහාර උත්සවයට සහභාගී වන්න.',
  ...
  event2_desc: 'ස්ථානයේ සිටම නවතම ආහාර නිෂ්පාදන ලබා ගැනීමට දේශීය කාබනික ගොවිපොල සමඟ හමුවන්න.',
  ...
  event4_desc: 'තවත් තිරසාර සහ පරිසර හිතකාමී ජීවන රටාවකට උපදෙස් සහ උපකාරක අත්දැකීම්.',
  ...
  event5_desc: 'කාබනික ගොවිපොල පිළිබඳව සෘජුව අත්දැකීම ලබා ගන්න හා තිරසාර කෘෂිකාර්මික ක්‍රම පිළිබඳ ඉගෙන ගන්න.',
  ...
  event6_desc: 'කාබනික රූපලාවණ්‍ය නිෂ්පාදන, සෞඛ්‍ය විසඳුම් සහ ස්වාභාවික සම සෙවුම් නිෂ්පාදන පිළිබඳ විමසන්න.',
 ...
 // ================= RESTAURANT NAMES =================
  ...
  "priceEats.harvest": "1,300 - 2,800",
   ...
   greenSmoothieDesc: "ස්පිනිච්, කැරට්, මාංගෝ සහ බද්ද ෆෝක් මිල්ක්",
    ...
    freshBroccoli_desc: "රසායනික ද්‍රව්‍ය නොමැතිව ස්වභාවිකව වගා කරන ලද නැවුම් කාබනික බ්‍රොකොලි. විටමින් වලින් පොහොසත් සහ සෞඛ්‍ය සම්පන්න ආහාර වේලක් සඳහා පරිපූර්ණයි.",
    organicHoodie_desc: "වාරික කාබනික කපු හුඩි - මෘදු, හුස්ම ගත හැකි සහ තිරසාර ලෙස එදිනෙදා සුවපහසුව සඳහා සාදා ඇත.",
...
Tot: "මුළු එකතුව",
Statement: "ඔබගේ ඇණවුම තහවුරු කිරීමෙන්, අපගේ නියමයන් සහ කොන්දේසි වලට ඔබ එකඟ වෙයි",
Required: "අවශ්‍යයි",
...
No_Special_Time_Request: "*බෙදා හැරීමේ උපදෙස් වල විශේෂ කාල ඉල්ලීම් පිළිගනු නොලැබේ.",
...
export function LanguageProvider({ children }: { children: React.ReactNode }) {
  ...
  const getProductName = (product: any) =>
    language === "en" ? product.nameEn || product.nameKey : product.nameSi || product.nameKey;

  const getProductDescription = (product: any) =>
    language === "en" ? product.descriptionEn || product.description : product.descriptionSi || product.description;

  return (
    <LanguageContext.Provider value={{ language, setLanguage: setLang, t, getProductName, getProductDescription }}>
      {children}
